...
To maximize my learning, I focused entirely on writing the mathematical backend (analytics.py) from scratch. My priority was deeply understanding the core quantitative fundamentals. To make my life easier, I used AI to generate the Streamlit frontend (app.py) and used a public random data generator (generate_csv.py) I found on github.
